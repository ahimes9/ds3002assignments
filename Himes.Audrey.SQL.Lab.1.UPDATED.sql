...
SELECT distinct product_name, unit_price FROM order_details 
JOIN products ON products.id = order_details.product_id 
WHERE unit_price= (SELECT MAX(unit_price) FROM order_details) OR unit_price= (SELECT MIN(unit_price) FROM order_details);
